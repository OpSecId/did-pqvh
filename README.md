...
Minimal create (server-generated signing key; read **`publicKeyMultibase`** / **`secretKeyMultibase`** from **`bootstrap`** in the JSON response if you need custody of that key):
